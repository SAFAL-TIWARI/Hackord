  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-24 pb-32">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="group relative col-span-1 sm:col-span-2 overflow-hidden rounded-3xl border border-border bg-card/30 backdrop-blur-xl p-8 shadow-card transition-all duration-300 hover:border-primary/30 hover:shadow-spatial hover:-translate-y-1">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="relative mt-8 h-48 w-full rounded-xl overflow-hidden border border-border bg-background/60">
               {/* Minimalist Kanban mock */}
               <div className="absolute inset-0 p-4 flex gap-4 opacity-70">
                 <div className="flex-1 rounded-lg border border-border bg-foreground/5 p-3 space-y-3">
                   ...
                   <div className="h-12 w-full bg-foreground/10 rounded-md" />
                 </div>
                 <div className="flex-1 rounded-lg border border-border bg-foreground/5 p-3 space-y-3">
        ...
        <div className="group relative col-span-1 overflow-hidden rounded-3xl border border-border bg-card/30 backdrop-blur-xl p-8 shadow-card transition-all duration-300 hover:border-brand-2/20 hover:shadow-spatial hover:-translate-y-1">
        ...
        <div className="group relative col-span-1 overflow-hidden rounded-3xl border border-border bg-card/30 backdrop-blur-xl p-8 shadow-card transition-all duration-300 hover:border-primary/30 hover:shadow-spatial hover:-translate-y-1">
          <div className="relative z-10 flex flex-col h-full">
            <div className="inline-flex rounded-xl bg-foreground/10 p-3 text-foreground mb-6 ring-1 ring-foreground/20 w-fit">
            ...
            <div className="mt-auto pt-8">
               <div className="relative h-24 w-full rounded-xl border border-border bg-card/90 overflow-hidden flex items-center justify-center">
                 ...
                 <div className="h-12 w-12 rounded-full border border-border flex items-center justify-center bg-foreground/5 relative z-10 shadow-[0_0_20px_rgba(255,255,255,0.05)] backdrop-blur-md">
        ...
        <div className="group relative col-span-1 sm:col-span-2 overflow-hidden rounded-3xl border border-border bg-card/30 backdrop-blur-xl p-8 shadow-card transition-all duration-300 hover:border-primary/20 hover:shadow-spatial hover:-translate-y-1">
