-- HackDiscord database schema
-- Idempotent: safe to run multiple times (all statements use IF NOT EXISTS / ON CONFLICT DO NOTHING)
...
-- Seed demo data (skipped silently if it already exists)
INSERT INTO rooms
...
VALUES
  (
    ...
    6, 'Active', 62,
    '2026-08-01', '2026-08-15', '2026-09-01', '2026-09-20', '2026-10-05'
  ),
  (
    'eth-global-2026',
    'ETHGlobal Delhi',
    ...
    4, 'Planning', 24,
    '2026-07-25', '2026-08-05', '2026-08-20', '2026-09-01', '2026-09-10'
  )
...
INSERT INTO messages (id, room_id, author_name, author_avatar, text, pinned, created_at) VALUES
  (
    'seed-m1', 'smart-india-2026',
    'Rohan Mehta', 'https://api.dicebear.com/9.x/glass/svg?seed=Rohan',
    'Kicked off the repo. Auth flow scaffolded 🚀',
    TRUE, NOW() - INTERVAL '3 hours'
  ),
  (
    'seed-m2', 'smart-india-2026',
    'Aarav Sharma', 'https://api.dicebear.com/9.x/glass/svg?seed=Aarav',
    'Nice! I''ll take the dashboard components.',
    FALSE, NOW() - INTERVAL '2 hours 46 minutes'
  ),
  (
    'seed-m3', 'smart-india-2026',
    'Priya Nair', 'https://api.dicebear.com/9.x/glass/svg?seed=Priya',
    'Uploaded the new mockups to Files.',
